...
public class InsertCommentCon extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String content = request.getParameter("cmt_content" != null ? request.getParameter("cmt_content") : "0");
		...
		TB_COMMENT insert = new TB_COMMENT(cmt_seq, content, id);
		...
		if (cnt > 0) {
			...
			System.out.println("Failed write comment!");
			response.sendRedirect("view.jsp");
		}
	}
