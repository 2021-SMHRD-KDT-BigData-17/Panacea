		...
		<div class="container flex-lg-column">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ms-auto flex-lg-column text-lg-center">
					<li class="nav-item"><a class="nav-link" href="#home">페이지
							소개</a></li>
					<li class="nav-item"><a class="nav-link" href="#service1">기능
							소개 1</a></li>
					<li class="nav-item"><a class="nav-link" href="#service2">기능
							소개 2</a></li>
					<li class="nav-item"><a class="nav-link" href="#service3">기능
							소개 3</a></li>
					<li class="nav-item"><a class="nav-link" href="signIn.html">로그인</a>
						<!-- 로그인 X 상태 : 유저 닉네임, 로그아웃 버튼 안 보이게 --></li>
				</ul>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-10">
						...
						<h2 data-aos="fade-up">
							<span class="text-brand">페이지 소개</span>
						</h2>
						<p class="lead mt-2 mb-4" data-aos="fade-up" data-aos-delay="200">1.
							상비약 커뮤니티 &nbsp;&nbsp;&nbsp; 2. 처방약 정보 검색 &nbsp;&nbsp;&nbsp; 3.
							내정보</p>
						<div data-aos="fade-up" data-aos-delay="400">
							<a href="list.jsp" class="btn btn-brand me-3">서비스 페이지 이동</a> <a
								href="signIn.html" class="link-custom">회원가입/로그인 이동</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row gy-4 justify-content-between">
					...
					<div class="col-auto">
						<div class="social-icons mt-1">
							<a href="#"><i class="lab la-twitter"></i></a> <a href="#"><i
								class="lab la-instagram"></i></a> <a href="#"><i
								class="lab la-facebook"></i></a> <a href="#"><i
