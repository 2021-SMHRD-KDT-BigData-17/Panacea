		...
		<form action="InsertCommentCon" method="post">
			<div class="board-view-wrap">
				...
				<div class="board-info">
					<span class="writer"> 작성자1 </span> <span> <span class="cnt">
							조회 10 </span>
					</span> <span class="date"> 2023.03.XX </span>
				</div>
				<div class="board-content">
					<p class="content">Lorem ipsum dolor sit, amet consectetur
						adipisicing elit. Quia, atque. Lorem ipsum dolor sit, amet
						consectetur adipisicing elit. Quia, atque. Lorem ipsum dolor sit,
						amet consectetur adipisicing elit. Quia, atque.</p>
				</div>
				<div class="board-btn">
					<div class="board-btn-left">
						<div class="btn-coment">
							<i class="las la-comments"></i> <span>댓글</span>
						</div>
						<div class="btn-like">
