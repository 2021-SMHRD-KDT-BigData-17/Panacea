		...
		<form action="UpdateCon" method="post">
			<div class="modify-wrap">
				...
				<table>
					<tr>
						<th class="id">아이디</th>
						<td colspan="2" class="modify-left"><input type="text"
							name="user_id" class="id-info" value="#" disabled></td>
					</tr>
					<tr>
						<th class="pw">비밀번호</th>
						<td colspan="2" class="modify-left"><input type="password"
							name="user_pw" class="pw-info"></td>
					</tr>
					<tr>
						<th class="email">이메일</th>
						<td colspan="2" class="modify-left"><input type="text"
							name="user_email" class="email-info"></td>
					</tr>
					<tr>
						<th class="nickname">닉네임</th>
						<td colspan="2" class="modify-left"><input type="text"
							name="user_nick" class="nickname-info"></td>
					</tr>
					<tr>
						<th class="type">회원유형</th>
						<td class="modify-left"><input type="text" name="user_type"
							class="type-info" value="#" disabled></td>
					</tr>
				</table>
			</div>
		</form>
